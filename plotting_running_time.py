"""
Counting the number of iterations in functions,
useful for testing and examining a function 
to reason about its running time.
"""
...
# Function that plots the number of iterations in a function
...
# Pass name of function in as a parameter
